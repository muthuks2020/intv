...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <body>
      ...
      <script type="text/javascript">
        function push(phone) {
            $.get( "update_status.php", { contact: phone } );
        }
           ...
           jQuery('.user-lists').DataTable({
            ...
            "render": function ( data, type, row ) {
              return '<span class="wr" data-phone="'+row[3]+'" data-type="file"> \
                ...
                <button href="#" class="btn btn-primary resume"><i class="fa fa-spinner fa-spin hidden" spinner-loading></i> <span class="upload-text">Upload Resume</span> <i class="fa fa-check  hidden spinner-done"></i></button></span>' + ((row[1] == 'Visualizer' || row[1] == 'CSE' || row[1] == 'Adops Analyst' || row[1] == 'Creative Designerexp'|| row[1] == 'Front End Developer'|| row[1] == 'Creative Designer'|| row[1] == 'Full Stack Developer'|| row[1] == 'ImageArtist' || row[1] == 'QA') ? '<button type="button" class="btn btn-primary" onclick="push('+ row[3] +')">Push</button>' : '')
            },
