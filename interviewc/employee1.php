...
<div style="margin-left:500px;"><input type="radio" name="details" value="fresher"   onclick="display(this.value)" />&nbsp;Fresher&nbsp;&nbsp;
...
<div class="leftside" >CTC (Per Annum):<span class="error">*</span></div>
...
<div class="rightside"><select name="source">
...
<div class="rightside"><input type="radio" name="friends" value="Yes" />&nbsp;Yes&nbsp;&nbsp;<input type="radio" name="friends" value="No"/>&nbsp;No&nbsp;<span class="error" id="friends1"></span></div>
...
<div style=" float:left"><?php if(isset($_REQUEST['success'])) { echo $_REQUEST['success']; }?>
