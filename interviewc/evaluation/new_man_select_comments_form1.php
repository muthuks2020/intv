  ...
  <head>
    ...
    <script type="text/javascript">
        ...
        function updateMStatus() {
            $.get( "update_mstatus.php", { id: <?php echo $_REQUEST['c'] ?> } );
        }
      ...
      <form class="form-horizontal well" style="min-height:177px;" action="mselected.php" name="mycomment" method="post" onSubmit="return validation()" >
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <li><label>Total Experince:</label>&nbsp;<input type="text" name="totalexperince" id="totalexperince" value="<?=$emp_name['totalexperince']?>" /></li>
            <li><label>Relevant Experince:</label>&nbsp;<input type="text" name="relevantexperince" id="relevantexperince" value="<?=$emp_name['relevantexperince']?>" /></li>
            <li><label>Recruiter:</label>&nbsp;<input type="text" name="recruiter" id="recruiter" value="<?php echo $emp_name['recruiter']?>" /></li>
            <br/>
          </div>
          <div class="col-md-6">
            ...
            <li><label>Team Allocated:</label>&nbsp; <input type="text" name="teamallocated" value="<?php echo $emp_name['teamallocated']?>" id="teamallocated" /></li>
          </div>
        </div>
        <table class="table">
          <tr>
        ...
        <table class="table " >
          ...
          <div class="row">
              <div class="col-md-12">
                  <label style="float:left"><b>Assessor2 Comments 1:</b><span class="error">*  </span></label>
                  <textarea name="comments" rows="3" cols="5" style="width:100%; resize:none; float:left" <?php echo $emp_name['mstatus']=='1' ? 'readonly' : '' ?> ><?=$emp_name['man_comments']?></textarea>
                  &nbsp;<span class="error" id="comments1"></span>
              </div>
          </div>
          <div class="row">
              <div class="col-md-12">
                  <label style="float:left"><b>Assessor2 Comments 2:</b><span class="error">*  </span></label>
                  <textarea name="comments2" rows="3" style="width:100%; resize:none; float:left" ><?=$emp_name['man_comment1']?></textarea>
                  <span class="error" id="comments2"></span>
              </div>
          </div>
        ...
        <div class="col-md-12 row toggle-status">
          ...
          <div class="btn-group" role="group" aria-label="...">
            ...
            <button type="button" class="btn btn-default selected-status" data-status="rejected">Rejected</button>
              <button type="button" class="btn btn-default selected-status" data-status="hold">Hold</button>
          </div>
...
<!--
        ...
        <div class="row" style="margin-left: 0px;">
          ...
          <button type="submit" class="btn btn-primary">Save</button>
            <a href="man_dashboard.php" class="btn btn-default">OK</a>
