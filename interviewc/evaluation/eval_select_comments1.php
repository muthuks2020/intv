...
<div class="main">
 ...
 <tr>
    ...
    <td>
        ...
        <?php foreach(array('5','4','3','2','1') as $value){ ?>
          <option value="<?php echo $value; ?>" <?php if($emp_name['CSevalrating'] == $value){ echo 'selected'; } ?>><?php echo $value; ?></option>
        <?php } ?>
        </select>
    </td>
  ...
  <tr>
    ...
    <td>
        <select name="DSevalrating" class="form-control">
          <?php foreach(array('5','4','3','2','1') as $value){ ?>
            <option value="<?php echo $value; ?>" <?php if($emp_name['DSevalrating'] == $value){ echo 'selected'; } ?>><?php echo $value; ?></option>
          <?php } ?>
...
Timeline | Frames | Optimization | Resolution |Image formats for web</p></td>
    <td>
        ...
        <?php foreach(array('5','4','3','2','1') as $value){ ?>
          <option value="<?php echo $value; ?>" <?php if($emp_name['SKPevalrating'] == $value){ echo 'selected'; } ?>><?php echo $value; ?></option>
        <?php } ?>
...
Difference between Spot & Process color</p>
    ...
    <td>
        <select name="SKLevalrating" class="form-control">
          <?php foreach(array('5','4','3','2','1') as $value){ ?>
            <option value="<?php echo $value; ?>" <?php if($emp_name['SKLevalrating'] == $value){ echo 'selected'; } ?>><?php echo $value; ?></option>
          <?php } ?>
...
Tabs and Tables| Tracking, Kerning, Leading | Links Panel | Seperation Preview | Ink Limit</p>
    ...
    <td>
        <select name="SKIDevalrating" class="form-control">
          <?php foreach(array('5','4','3','2','1') as $value){ ?>
            <option value="<?php echo $value; ?>" <?php if($emp_name['SKIDevalrating'] == $value){ echo 'selected'; } ?>><?php echo $value; ?></option>
          <?php } ?>
        </select>
    </td>
...
Masking | FPS</p></td>
    <td>
        <select name="rating_animate_cc" class="form-control">
        <?php foreach(array('5','4','3','2','1') as $value){ ?>
            <option value="<?php echo $value; ?>" <?php if($emp_name['rating_animate_cc'] == $value){ echo 'selected'; } ?>><?php echo $value; ?></option>
          <?php } ?>
        </select>
    </td>
   ...
   <tr>
    ...
    <td>
        <select name="rating_html5" class="form-control">
        <?php foreach(array('5','4','3','2','1') as $value){ ?>
            <option value="<?php echo $value; ?>" <?php if($emp_name['rating_html5'] == $value){ echo 'selected'; } ?>><?php echo $value; ?></option>
          <?php } ?>
        </select>
    </td>
   ...
   <tr>
    ...
    <td>
        ...
        <?php foreach(array('5','4','3','2','1') as $value){ ?>
            <option value="<?php echo $value; ?>" <?php if($emp_name['SKAevalrating'] == $value){ echo 'selected'; } ?>><?php echo $value; ?></option>
          <?php } ?>
        </select>
    </td>
 ...
 <tr>
    ...
    <td>
        <select name="rating_edge" class="form-control">
        <?php foreach(array('5','4','3','2','1') as $value){ ?>
            <option value="<?php echo $value; ?>" <?php if($emp_name['rating_edge'] == $value){ echo 'selected'; } ?>><?php echo $value; ?></option>
          <?php } ?>
        </select>
    </td>
  ...
  <tr>
    ...
    <td colspan='2'><textarea name="training_comments" rows="3" cols="5" style="resize:none; width:100%" required><?=$emp_name['training_comments']?></textarea></td>
    <!--<td>
        <select name="TRevalrating" class="form-control">
            <option value="5"<?php if($emp_name['TRevalrating']=='5'){?> selected<?php } ?>>5</option>
            <option value="4"<?php if($emp_name['TRevalrating']=='4'){?> selected<?php } ?>>4</option>
            <option value="3"<?php if($emp_name['TRevalrating']=='3'){?> selected<?php } ?>>3</option>
            <option value="2"<?php if($emp_name['TRevalrating']=='2'){?> selected<?php } ?>>2</option>
            <option value="1"<?php if($emp_name['TRevalrating']=='1'){?> selected<?php } ?>>1</option>
        </select>
    </td>-->
  ...
  <tr>
    ...
    <td colspan="2"><textarea name="othercomments" rows="3" cols="5" style="resize:none; width:100%" required><?=$emp_name['eval_comments']?></textarea></td>
  </tr>

  </table>
  <div>
    <label>Recommended for next interview panel:</label>&nbsp;
    <input name="recomended" value="yes"<?php if($emp_name['recomended']=='yes'){?> checked<?php } ?> type="checkbox" /> Yes&nbsp;&nbsp;
    <input name="recomended" value="no"<?php if($emp_name['recomended']=='no'){?> checked<?php } ?> type="checkbox"/> No&nbsp;&nbsp;<span class="error" id="recomendeds"></span>
</div>
