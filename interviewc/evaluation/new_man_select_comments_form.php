      ...
      <form class="form-horizontal well" style="min-height:177px;" action="mselected.php" name="mycomment" method="post" onSubmit="return validation()" >
        ...
        <div class="col-md-12 row toggle-status">
          ...
          <div class="btn-group" role="group" aria-label="...">
            <button type="button" class="btn btn-default selected-status" data-status="selected" onclick="hideComments2();">Selected</button>
            <button type="button" class="btn btn-default selected-status" data-status="rejected" onclick="hideComments2();">Rejected</button>
             <button type="button" class="btn btn-default selected-status" data-status="hold" onclick="hideComments2();">Hold</button>
              <button type="button" class="btn btn-default selected-status" data-status="next_level" onclick="updateMStatus();">Next Level</button>
          </div>
