...
//echo "update `hub_request` set vp_comments  = '".$_POST['comments']."', vp_updated_by ='".$_SESSION['user']."',vp_updated_at='".$approve_date."', status = '2', vpstatus = '2' where `employee_id` = '".$_POST['eid']."'"; exit;
$appQury = mysql_query("update `hub_request` set vp_comments  = '".$_POST['comments']."', vp_updated_by ='".$_SESSION['user']."',vp_updated_at='".$approve_date."', status = '2',vpstatus = '2',cvpstatus='3' where `rid` = '".$_POST['eid']."'") or die(mysql_error());
...
$ename= mysql_fetch_array($qry);
 ...
 <div class="main">
        <form class="form-horizontal well" style="min-height:177px;" action="vp_cancel_comm.php" name="mycomment" method="post" onSubmit="return validation()" >
