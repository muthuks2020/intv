...
$count++;
  ...
  <tr >
    ...
    <td><?php if($mcontact['status']=='1') { ?><button type="button" id="btn-spc" class="btn btn-success">Selected</button><?php } else {?><button type="button" class="btn btn-danger">Rejected</button><?php } ?><div class="btn btn-info"><a href="assviewdetails.php?c=<?=$mcontact['id']?>">View Details</a></td>
    ...
    <td><?php if($mcontact['mstatus']=='1'){?><button type="button" class="btn btn-success">Selected</button>
	<div class="btn btn-info"><a href="man_select_comments1.php?c=<?=$mcontact['id']?>">View Details</a>
	<?php } elseif($mcontact['mstatus']=='2') {?><button type="button" class="btn btn-danger">Rejected</button>
	<div class="btn btn-info"><a href="man_select_comments1.php?c=<?=$mcontact['id']?>">View Details</a>
	<?php } elseif($mcontact['mstatus']=='3') {?><button type="button" class="btn btn-warning">On Hold</button>
	<div class="btn btn-info"><a href="man_select_comments1.php?c=<?=$mcontact['id']?>">View Details</a>
	<?php } else { echo "Still No Manager Evaluation";}?></td>
...
<td><?=$mcontact['manager_emp_name']?></td>
    ...
    <td><?php if($mcontact['mstatus']=='1'){?><button type="button" class="btn btn-success">Selected</button><?php } elseif($mcontact['mstatus']=='2') {?><button type="button" class="btn btn-danger">Rejected</button>
	<div class="btn btn-info"><a href="man_select_comments1.php?c=<?=$mcontact['id']?>">View Details</a>
	<?php } ?></td>
