...
if($usertype =="4")
{
$appQury = mysql_query("update `hub_request` set cvp_comments  = '".mysql_real_escape_string($_POST['comments'])."',  cvp_updated_by ='".$_SESSION['user']."', cvp_updated_at='".$approve_date."', vpstatus='2', cvpstatus = '2' where `rid` = '".$_POST['eid']."'");
}
else
{
$appQury = mysql_query("update `hub_request` set vp_comments  = '".mysql_real_escape_string($_POST['comments'])."',  vp_updated_by ='".$_SESSION['user']."',vp_updated_at='".$approve_date."', opmstatus='2', vpstatus = '2',cvpstatus='3' where `rid` = '".$_POST['eid']."'");
}			
if($rt =='back')
{
...
$ename= mysql_fetch_array($qry);
 ...
 <div class="main">
        <form class="form-horizontal well" style="min-height:177px;" action="cvp_unapprove_comm.php" name="mycomment" method="post" onSubmit="return validation()" >
