...
$apprQuery = mysql_query("select *from hub_manpower where reporting_manager_id='".$_REQUEST['eid']."'")or die(mysql_error());
...
?>
                    ...
                    <tr >
						...
						{
						?>
						<a href="insertreason.php?eid=<?=$res['eid']?>"><img src="images/add.png" title="Add" /></a>
						<?php } else {
							?>
							<a href="deletereason.php?eid=<?=$res['eid']?>"><img src="images/trash.png" title="Delete" /></a>
							<?php
						}
						?>
						</td>
