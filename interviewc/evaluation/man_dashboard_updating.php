...
<table class="table table-condensed" > <table class="user-lists table">
             <thead>
                <tr>
                    ...
                    <th style="width: 25%">Assessor1 status</th>
      ...
      <script type="text/javascript">
          jQuery(function() {
            ...
            jQuery('.user-lists').DataTable({
              ...
              "serverSide": true,
              "ajax": {
                // url: "/adda/interviewc/evaluation/async.php",
                url: "/adda/interviewc/evaluation/async.php",
                data: {
                  method: 'anc'
                }
              ...
              "columnDefs": [{
                  ...
                  "data": null,
                  "render": function(data, type, row) {
                    return '<a target="_blank" href="man_select_comments_updating.php?c='+row[8]+'">Click here</a>';
                    // var cl = 'btn-primary';
                    // var tp = '';
                    ...
                    // }else if(row[5] == '0'){
                    //   tp += '<a target="_blank" class="btn btn-sm '+cl+'" href="man_select_comments.php?c='+row[8]+'">Selected</a>';
                    // }else{
                    //   tp += '<button class="btn btn-sm btn-primary" type="button">Selected</button>';
                    // }
