  ...
  <div class="container">
    ...
    <div class="container">
        ...
        <header>
            ...
            <div class="head">
                <span id="tit"><img src="assets/images/bckfl-maped-lst.png" /></span>
            </div>
                ...
                <table class="table table-condensed" border="0">
                    <tr>
                       <!-- <th scope="col">No</th>
                        ...
                        <th scope="col">No</th>
                        <th scope="col">Resigned Employee Name</th>
                        <th scope="col">Resigned Employee Designation</th>
...
$mapQuery = mysql_query("SELECT * FROM `hub_backfill_map` WHERE `mapping`='1' and Request_type='Backfill'")or die(mysql_error());
...
?>
                    ...
                    <tr >
                        ...
                        <td><?php echo $res['app_emp_desig'];?></td>
